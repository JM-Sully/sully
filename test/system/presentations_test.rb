...
class PresentationsTest < ApplicationSystemTestCase
  ...
  test "should create presentation" do
    ...
    fill_in "Organization", with: @presentation.organization
    fill_in "Organization url", with: @presentation.organization_url
    fill_in "Presented at", with: @presentation.presented_at
    fill_in "Title", with: @presentation.title
    fill_in "Presentation url", with: @presentation.presentation_url
  ...
  test "should update Presentation" do
    ...
    fill_in "Presented at", with: @presentation.presented_at
    fill_in "Title", with: @presentation.title
    fill_in "Url", with: @presentation.url
